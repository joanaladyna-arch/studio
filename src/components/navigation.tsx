...
import { Home, Library, PenTool, User, BarChart3, Heart, Feather, LogOut, PlusCircle } from "lucide-react";
          ...
          {navItems.map((item) => {
            ...
            return (
              <Link
                ...
                href={item.href}
                className={cn(
                  "group flex items-center gap-2 transition-all duration-300 py-2 px-3 rounded-full",
                  isActive 
        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              href={item.href}
              className={cn(
                "flex flex-col items-center justify-center gap-1 transition-all duration-500 p-1 rounded-2xl min-w-[45px]",
                isActive 
                  ? "text-primary" 
            ...
            >
              ...
              <span className={cn(
                "text-[8px] font-headline italic tracking-tight font-bold transition-all",
